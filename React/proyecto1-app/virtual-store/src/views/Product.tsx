...
function Product() {
    ...
    const { id } = useParams<{ id: string }>(); // Obtén el parámetro id de la URL
    const product = products.find((product) => product.id === id); // Encuentra el producto por su id
    
   
    if (!product) {
      // Si no se encuentra el producto, muestra un mensaje de error centrado
      return (
          <>
              <NavBar />
              <HeroSection />
                    ...
                    <div className="container">
                        <div className="columns-container">
                            <div className={styles.error}>
                                <h1>El producto no se encontró.</h1>
                            </div>
                        </div>
                    </div>
                </main>
